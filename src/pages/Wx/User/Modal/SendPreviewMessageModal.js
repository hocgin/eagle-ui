...
@connect(({ global, loading, ...rest }) => {
  return {
    confirmLoading: loading.effects['wxMpMessage/sendPreviewMessageToUser'],
  };
}, dispatch => ({
  $sendPreviewMessageToUser: (args = {}) => dispatch({ type: 'wxMpMessage/sendPreviewMessageToUser', ...args }),
}))
