...
@connect(({
  ...
  $getOne: (args = {}) => dispatch({ type: 'role/getOne', ...args }),
}))
class DetailModal extends PureComponent {
  ...
  render() {
    ...
    let { title, createdAt, creatorName, lastUpdatedAt, remark, lastUpdaterName, roleCode, platformName, enabledName, authorities } = detail;
